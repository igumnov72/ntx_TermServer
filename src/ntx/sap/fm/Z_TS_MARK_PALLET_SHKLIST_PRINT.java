...
/**
 * Маркировка паллет - Печать ШК
 */
public class Z_TS_MARK_PALLET_SHKLIST_PRINT {
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_MARK_PALLET_SHKLIST_PRINT");
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_MARK_PALLET_SHKLIST_PRINT:");
      ...
      System.err.println("Error calling SAP procedure Z_TS_MARK_PALLET_SHKLIST_PRINT:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_MARK_PALLET_SHKLIST_PRINT: " + err);
      }
    }
  }

  private static synchronized Exception execute(Z_TS_MARK_PALLET_SHKLIST_PRINT params) {
    Exception ret = null;
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_MARK_PALLET_SHKLIST_PRINT");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_MARK_PALLET_SHKLIST_PRINT not found in SAP.");
    }
