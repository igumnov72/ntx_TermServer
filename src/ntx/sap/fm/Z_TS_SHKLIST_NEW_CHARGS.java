...
/**
 * Формирование новых партий ПУ
 */
public class Z_TS_SHKLIST_NEW_CHARGS {

  // importing params
  public String USER_SHK = ""; // Штрих-код
  public String W_CHARG_PU = ""; // Номер партии
  public String W_KRATN = ""; // Кратность
  public String W_TEST = ""; // Признак Тест
  //
  // exporting params
  ...
  public ZTS_INFO_S[] IT_INFO = new ZTS_INFO_S[0]; // Инфо
  //
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_SHKLIST_NEW_CHARGS");
    } else if (TSparams.logDocLevel >= 2) {
      System.out.println("Вызов ФМ Z_TS_SHKLIST_NEW_CHARGS:");
      System.out.println("  USER_SHK=" + USER_SHK);
      System.out.println("  W_CHARG_PU=" + W_CHARG_PU);
      System.out.println("  W_KRATN=" + W_KRATN);
      System.out.println("  W_TEST=" + W_TEST);
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_SHKLIST_NEW_CHARGS:");
      ...
      System.err.println("Error calling SAP procedure Z_TS_SHKLIST_NEW_CHARGS:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_SHKLIST_NEW_CHARGS: " + err);
      }
    }
  }

  private static synchronized Exception execute(Z_TS_SHKLIST_NEW_CHARGS params) {
    Exception ret = null;
    ...
    try {
      ...
      impParams.setValue("W_KRATN", params.W_KRATN);
      impParams.setValue("W_TEST", params.W_TEST);
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_SHKLIST_NEW_CHARGS");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_SHKLIST_NEW_CHARGS not found in SAP.");
    }
