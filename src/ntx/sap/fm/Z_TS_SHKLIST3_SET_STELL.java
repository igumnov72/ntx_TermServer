...
/**
 * Установка нового стеллажа
 */
public class Z_TS_SHKLIST3_SET_STELL {
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_SHKLIST3_SET_STELL");
    ...
    if (e == null) {
      ...
      System.err.println("Error calling SAP procedure Z_TS_SHKLIST3_SET_STELL:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_SHKLIST3_SET_STELL: " + err);
      }
    }
  }

  private static synchronized Exception execute(Z_TS_SHKLIST3_SET_STELL params) {
    Exception ret = null;
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_SHKLIST3_SET_STELL");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_SHKLIST3_SET_STELL not found in SAP.");
    }
