...
//  public ZTS_SHK_S[] IT = new ZTS_SHK_S[0]; // Table of zts_shk
  //
  public String W_NEW_CHARG_PU  = "";   // номер новый номер партии ПУ
...
//  }
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_IS_CHARG_PU");
...
//      System.out.println("  IT.length=" + IT.length);
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_IS_CHARG_PU:");
...
//        System.out.println("  IT.length=" + IT.length);
      ...
      System.err.println("Error calling SAP procedure Z_TS_IS_CHARG_PU:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_IS_CHARG_PU: " + err);
      }
    }
  }

  private static synchronized Exception execute(Z_TS_IS_CHARG_PU params) {
    Exception ret = null;
...
//        }
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_IS_CHARG_PU");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_IS_CHARG_PU not found in SAP.");
    }
