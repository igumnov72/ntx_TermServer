...
/**
 * Сохранение данных по паллете сразу в ячейку
 */
public class Z_TS_IN9 {
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_IN9");
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_IN9:");
      ...
      System.err.println("Error calling SAP procedure Z_TS_IN9:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_IN9: " + err);
      }
    }
  }

  private static synchronized JCoException execute(Z_TS_IN9 params) {
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_IN9");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_IN9 not found in SAP.");
    }
