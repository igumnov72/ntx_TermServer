 ...
 * @author amolchanov
 */
//public class Z_TS_SHKLIST_NEW_CHARG {
//    
//}
...
//  public String SHKLIST = ""; // Список ШК
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_SHKLIST_NEW_CHARG");
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_SHKLIST_NEW_CHARG:");
//        System.out.println("  SHKLIST=" + SHKLIST);
      ...
      System.err.println("Error calling SAP procedure Z_TS_SHKLIST_NEW_CHARG:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_SHKLIST_NEW_CHARG: " + err);
      }
    }
  }

  private static synchronized Exception execute(Z_TS_SHKLIST_NEW_CHARG params) {
    Exception ret = null;
...
//        params.SHKLIST = expParams.getString("SHKLIST");
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_SHKLIST_NEW_CHARG");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_SHKLIST_NEW_CHARG not found in SAP.");
    }
