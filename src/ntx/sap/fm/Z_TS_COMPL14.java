...
/**
 * Получение ведомости свободной комплектации по ячейке (нов)
 */
public class Z_TS_COMPL14 {
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_COMPL14");
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_COMPL14:");
      ...
      System.err.println("Error calling SAP procedure Z_TS_COMPL14:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_COMPL14: " + err);
      }
    }
  }
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_COMPL14");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_COMPL14 not found in SAP.");
    }
