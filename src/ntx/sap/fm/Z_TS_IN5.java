...
public class Z_TS_IN5 {
  ...
  //
  // exporting params
  public int N_ERR_DP = 0; // Число партий с ошибками в дате пр-ва
  ...
  public void execute() {
    ...
    if (TSparams.logDocLevel == 1) {
      System.out.println("Вызов ФМ Z_TS_IN5");
    ...
    if (e == null) {
      if (TSparams.logDocLevel >= 2) {
        System.out.println("Возврат из ФМ Z_TS_IN5:");
        System.out.println("  N_ERR_DP=" + N_ERR_DP);
      ...
      System.err.println("Error calling SAP procedure Z_TS_IN5:");
      ...
      if (errFull.startsWith("com.sap.conn.jco.JCoException: (104) JCO_ERROR_SYSTEM_FAILURE:")) {
        System.out.println("!!! Error in Z_TS_IN5: " + err);
      }
    }
  }

  private static synchronized JCoException execute(Z_TS_IN5 params) {
    ...
    if (ret == null) {
      params.N_ERR_DP = expParams.getInt("N_ERR_DP");
  ...
  private static JCoException init() {
    try {
      function = SAPconn.getFunction("Z_TS_IN5");
    } catch (JCoException e) {
      return e;
    }

    if (function == null) {
      return new JCoException(0, "Z_TS_IN5 not found in SAP.");
    }
